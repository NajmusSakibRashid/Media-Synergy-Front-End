...
export default function profilePage({params}) {
  ...
  useEffect(() => {
    ...
    if(!postId)
      return;
    const url=`https://graph.facebook.com/v19.0/${postId}/insights?metric=post_reactions_by_type_total,post_impressions_unique,post_engaged_users,post_impressions_fan&access_token=${process.env.NEXT_PUBLIC_FACEBOOK_TOKEN}`;
    const fetchData = async () => {
