        ...
        <div className="mid w-8/12 self-center pt-4">
          <div className="card card-bordered bg-base-200 w-full shadow-xl p-4 gap-4">
            ...
            {analytics&&<BarChart
              chartData={[
                ...
                },
                {
                  ...
                  data: [analytics.data[1].values[0].value, analytics.data[2].values[0].value],
                }
              ]}
            />}
            ...
            {analytics&&reactions&&<AnalyticsTripleReach
              ...
              postViews={`${analytics.data[1].values[0].value?analytics.data[1].values[0].value:0}`}
              fanViews={`${analytics.data[3].values[0].value?analytics.data[3].values[0].value:0}`}
              storyViews={`${analytics.data[4].values[0].value?analytics.data[4].values[0].value:0}`}
            />}
