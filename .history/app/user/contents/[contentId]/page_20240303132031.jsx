              ...
              <div className="card-body basis-1/2 flex flex-col justify-around">
                ...
                <div className="flex w-full justify-between">
                  ...
                  {content&&content.consumer&&<ContentList
                    listName='Consumers'
                    lists={content.consumer.map((consumer,index) => <div>{`${consumer.ageFrom} to ${consumer.ageTo} ${consumer.gender.toLowerCase==='both'?'males and females':consumer.gender+'s'}`}</div>)}
                  />}
                </div>
