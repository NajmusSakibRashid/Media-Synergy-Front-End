            ...
            <div className="flex">
              <div className="basis-1/2 flex flex-col justify-around items-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {content&&content.profile&&content.profile.map((profile,index) => <ProfileCardContent key={index}>{profile}</ProfileCardContent>)}
                </div>
              </div>
              <div className="card-body basis-1/2 flex flex-col justify-around">
                ...
                <div className="flex w-full justify-between">
                  ...
                  {content&&content.consumer&&<ContentList
                    listName='Consumers'
                    lists={content.consumer.map((consumer,index) => <div key={index}>{`${consumer.ageFrom} to ${consumer.ageTo} ${consumer.gender.toLowerCase==='both'?'males and females':consumer.gender+'s'}`}</div>)}
                  />}
                </div>
