...
export default function page() {
  ...
  return (
    <div className="card shadow-xl w-full bg-base-200 p-4 gap-4">
      ...
      <div className="card-body flex flex-col w-full gap-2 justify-around">
      ...
      <button className="btn btn-success w-full max-w-xs self-center" onClick={saveHandler}>Publish</button>
    </div>
  )
}
