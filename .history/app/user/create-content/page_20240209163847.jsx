    ...
    <div className="card shadow-xl w-full bg-base-200 p-4 gap-4">
      ...
      <div className="flex gap-4">
        ...
        <div className="basis-1/2 card-body flex flex-col w-full gap-2 jsutify-around">
          ...
          {content.media && <img src={URL.createObjectURL(content.media)} alt="media" />}
          <input onChange={(e) => { changeHandler(e, (data) => URL.createObjectURL(data[0])) }} name='media' type="file" className="file-input file-input-bordered w-full " />
        </div>
      </div>
