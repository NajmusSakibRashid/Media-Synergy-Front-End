    ...
    <div id="scheduling-htmlForm" className={`${show?'block':'hidden'} z-40 fixed top-0 left-0 h-screen w-screen`} style={{backgroundColor: 'rgba(0,0,0,.5)'}}>
      <div className="bg-base-100 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 rounded-xl p-4 max-h-screen overflow-y-scroll opacity-100">
        ...
        <div className="flex justify-between items-center m-4">
          <input onChange={checkBoxHandler} value="facebook" type="checkbox" className="checkbox checkbox-xl checkbox-primary" />
          ...
          {/* <input onChange={checkBoxHandler} value="twitter" type="checkbox" className="checkbox checkbox-xl checkbox-primary" />
          ...
          <input onChange={checkBoxHandler} value="instagram" type="checkbox" className="checkbox checkbox-xl checkbox-primary" />
          ...
          <input onChange={checkBoxHandler} value="youtube" type="checkbox" className="checkbox checkbox-xl checkbox-primary" />
          ...
          <input onChange={checkBoxHandler} value="linkedin" type="checkbox" className="checkbox checkbox-xl checkbox-primary" />
          ...
          {/* <input onChange={checkBoxHandler} value="tiktok" type="checkbox" className="checkbox checkbox-xl checkbox-primary" />
