...
export default function schedulehtmlForm() {
  const [show, setShow] = useState(false);
  return (
    <div id="scheduling-htmlForm" className={`${show?'block':'none'} z-40 fixed top-0 left-0 h-screen w-screen`} style="background-color: rgba(0,0,0,.5);">
      <div className="bg-base-100 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 rounded-xl p-4 max-h-screen overflow-y-scroll opacity-100">
        <div className="absolute right-0 top-0 p-1" onclick="document.getElementById('scheduling-htmlForm').style.display='none'">
          <img src="https://icons.veryicon.com/png/o/miscellaneous/medium-thin-linear-icon/cross-23.png" alt="" className="w-4" />
        </div>
        <div className="flex m-4">
          <img src="https://static-00.iconduck.com/assets.00/fast-food-illustration-2048x1469-7bth2szr.png" alt="" className="w-64" />
